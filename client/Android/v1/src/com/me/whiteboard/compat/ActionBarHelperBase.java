...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	private void setupActionBar() {
		...
		/*
		 * TextView titleText2 = new TextView(mActivity, null,
		 * R.attr.actionbarCompatTitleStyle);
	 ...
	 * {@link com.mobiact.compatible.ActionBarHelperBase#setRefreshActionItemState(boolean)}
	 * .
	 */
	class MyTab {
		Button a;
		...
		public MyTab setText(String s) {
			a.setText(s);
			return this;
		}
		/*
		 * public setTabListener() {
		 * 
		 * }
		 */
	}
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		this.getActionBarCompat().removeAllViews();
		setupActionBar();
		for (int i = 0; i < menu.size(); i++) {
			MenuItem item = menu.getItem(i);
			if (mActionItemIds.contains(item.getItemId())) {
